...
openssl ca -gencrl -out /opt/CA/crl/crl.pem -config /etc/ssl/openssl.cnf
...
chmod -R 750 /opt/pm2/
chmod 770 /opt/pm2/asl-ca-backend/src/schema.gql
chmod 770 -R /opt/pm2/asl-ca-backend/tmp
